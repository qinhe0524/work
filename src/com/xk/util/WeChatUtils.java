...
public final class WeChatUtils {
    ...
    //会来活
    public static String appId="wx5222653137e3fb9f";
    public static String appSecret="79fc7469f63d48befdb934de02e40259";
    public static String token="ijfekQiReH3NFLLtCwY2iw3O545EinIR";
    public static String wxGzhWorkOrder = "UYWzmr4zgOdDIfr2e6rh5VGqs8fJW4-48J41J-0gRIU"; // 工单状态通知Key
    public static String weGzhReport = "UYWzmr4zgOdDIfr2e6rh5VGqs8fJW4-48J41J-0gRIU"; // 报告生成通知Key
    public static String netUrl="http://wechat.huilaihuo.com/partwechat/";


    //灵工云服
//    public static String appId="wxcd60c4b6d9c48fef";
//    public static String appSecret="c679e1b1b68dd22d6800573ad09259a9";
//    public static String token="218z02c56977lgyfptlcxkimhqzsxq27";
//    public static String wxGzhWorkOrder = "xxxxx"; // 工单状态通知Key
//    public static String weGzhReport = "xxxxxx"; // 报告生成通知Key
//    public static String netUrl="http://wechat.lgyfpt.com/partwechat/";
    ...
    public static boolean sendWxGzh(String openId, String templateId, String first, String remark, Map<String, Object> keywordMap) {
        ...
        Map<String, Object> resultMap = WeChatUtils.wxReqDataPost(url, JSONObject.fromObject(map).toString());
    ...
    public static Map<String, Object> getUserInfo(String openId) {
        String url = "https://api.weixin.qq.com/cgi-bin/user/info?access_token=" + WeChatUtils.getToken() + "&openid=" + openId + "&lang=zh_CN";
    ...
    public static String getToken() {
        ...
        WeChatUtils.tokenMap = new HashMap<String,String>();
