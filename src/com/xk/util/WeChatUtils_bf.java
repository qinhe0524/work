 ...
 */
@Component
public final class WeChatUtils_bf {
    private static Map<String, String> tokenMap = null;
    public static String appId="wxc34b153d63f865ad";
    public static String appSecret="e744739e58834a078cd73ac66420dd90";
    public static String token="218z02c56977plcrr6lcxkimhqzsxq27";
    public static String wxGzhWorkOrder = "xxxxx"; // 工单状态通知Key
    public static String weGzhReport = "xxxxxx"; // 报告生成通知Key
    public static String netUrl="http://testwechat.lgyfpt.com/partwechat/";
	...
	public static String getActionUrl(String action){
		Map<String,String> actionUrlMap=new HashMap<String,String>();
		actionUrlMap.put("reg", "FreeWorker/reg");
		return netUrl+actionUrlMap.get(action);
	}
    /**
     * 发送报告生成通知
    ...
    public static boolean sendWeGzhReport(String openId, String first, String remark, Map<String, Object> keywordMap) {
        return sendWxGzh(openId, WeChatUtils_bf.weGzhReport, first, remark, keywordMap);
    }
    ...
    public static boolean sendWxGzhWorkOrder(String openId, String first, String remark, Map<String, Object> keywordMap) {
        return sendWxGzh(openId, WeChatUtils_bf.wxGzhWorkOrder, first, remark, keywordMap);
    }
    ...
    public static boolean sendWxGzh(String openId, String templateId, String first, String remark, Map<String, Object> keywordMap) {
        ...
        String url = "https://api.weixin.qq.com/cgi-bin/message/template/send?access_token=" + WeChatUtils_bf.getToken();
        ...
        for (Map.Entry entrySet : keywordMap.entrySet()) {
            Map keyword1Map = new HashMap<String,Object>();
        ...
        Map<String, Object> resultMap = WeChatUtils_bf.wxReqDataPost(url, JSONObject.fromObject(map).toString());
    ...
    public static Map<String, Object> getUserInfo(String openId) {
        String url = "https://api.weixin.qq.com/cgi-bin/user/info?access_token=" + WeChatUtils_bf.getToken() + "&openid=" + openId + "&lang=zh_CN";
        Map resultMap = WeChatUtils_bf.wxReqDataGet(url);
        return resultMap;
    }
    ...
    public static String getToken() {
        Map<String, String> tokenMap = WeChatUtils_bf.tokenMap;
        // 微信的access_token有效期是7200秒，所以我们的过期时间要比微信的快token
        if (tokenMap != null && Long.parseLong(tokenMap.get("date")) >= (new Date().getTime() + (7200 * 1000))) {
            return tokenMap.get("access_token");
        }
 
       
        String url = "https://api.weixin.qq.com/cgi-bin/token?appid=" + appId+ "&secret=" + appSecret + "&grant_type=" + clientCredential;
 
        Map<String, Object> resultMap = WeChatUtils_bf.wxReqDataGet(url);
        if (resultMap == null){
        	System.out.print("系统异常");
        }
 
        String token = (String) resultMap.get("access_token");
        WeChatUtils_bf.tokenMap = new HashMap<String,String>();
        WeChatUtils_bf.tokenMap.put("date", String.valueOf(new Date().getTime()));
        WeChatUtils_bf.tokenMap.put("access_token", token);
    ...
    public static Map<String, Object> getOpenIdAndSessionKey(String code) {
        String url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=" + appId + "&secret=" + appSecret + "&grant_type=" + authorizationCode + "&code=" + code;
        return WeChatUtils_bf.wxReqDataGet(url);
    }
    ...
    public static Map<String, Object> wxReqDataPost(String url, String params) {
        try {
            Map<String, Object> reulstMap = reqPost(url, params);
    ...
    public static Map<String, Object> wxReqDataGet(String url) {
        try {
            Map<String, Object> reulstMap = reqGetMap(url);
    ...
    private static Map<String, Object> domSourceToMap(DOMSource domSource) {
        try {
            ...
            Map<String, Object> dataMap = json;
