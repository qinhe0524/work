...
//		QRCodeUtil.encode(text, "C:/Users/Administrator/Desktop/二维码/myGirl.jpg", "C:/Users/Administrator/Desktop/二维码", true);
//	}
	public static void main(String[] args) throws Exception {
        String text = "http://www.dans88.com.cn";
        QRCodeUtil.encode(text,"","C:/Users/Administrator/Desktop/二维码",true,"sdf");}

	public BufferedImage  createMyImage(String content, String imgPath,
			boolean needCompress) throws Exception{
			BufferedImage image = QRCodeUtil.createImage(content, imgPath,
					needCompress);
